...
declare class FollowController {
    ...
    followUser: (followee_id: string, followee_key_id: string, followee_public_key?: string | null) => Promise<{
        is_following: boolean;
        is_approved: boolean;
        email: string;
    } | null>;
    approveUser: (followId: string, follower_public_key: string, group_id: string, encrypted_by_user_group_sym_key: string, own_key_id: string, private_key: string, allowProfileRead?: boolean) => Promise<{
        approved: boolean;
    } | null>;
