...
import { PostResource, LikeResponse } from "./types";
declare class PostController {
    auth: AuthController;
    constructor(auth: AuthController);
    getPost: (id: string) => Promise<PostResource | null>;
    createPost: (group_id: string, encrypted_sym_key: string, text: string | null, media_encoding: string | null, media: Buffer | null) => Promise<null>;
